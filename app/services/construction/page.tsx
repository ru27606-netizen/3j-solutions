  ...
  return (
    <div className="font-sans text-gray-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-700 mb-8 leading-relaxed">
               At 3J Solutions, our construction expertise covers all aspects of building, from
      foundations to finishing. We deliver durable, innovative, and cost-effective 
      construction services tailored to residential, commercial, and industrial needs. </p>
      ...
      <section className="py-16 bg-white">
        <div className="container-balanced max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="text-4xl mb-4">🎨</div>
              <h3 className="text-xl font-semibold mb-3">Construction Projects</h3>
              <p className="text-gray-600">Transform your existing spaces with our comprehensive construction and remodeling services.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        ...
        <li>Foundation, concrete, and structural works</li>
        <li>Ceiling, steel, and carpentry works</li>
        <li>Aluminum, glass, and façade installations</li>
        <li>Interior & exterior fit-outs</li>
              </ul>
            </div>
        ...
        <li>Roofing, waterproofing & insulation</li>
        <li>Electrical, plumbing & MEP integration</li>
        <li>Painting, flooring & tiling works</li>
        <li>Landscape & site development</li>
        <li>Project management & turnkey solutions</li>
        </ul>
            </div>
          </div>
        </div>
